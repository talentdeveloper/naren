...
class TeamMemberInvitationScreen extends React.Component {
    ...
    onSubmit() {
        ...
        if (this.state.user) {
            ...
            this.props.inviteMember(this.state.email, this.state.currentClient.id, permissions)
        }
...
const mapDispatchToProps = dispatch => ({
    inviteMember: (email, client, permissions) => dispatch(UserActions.inviteMember(email, client, permissions)),
