...
import { Button, Image, Item, Header, Icon, Input, TextArea } from 'semantic-ui-react';
        ...
        return <Item.Group>
            ...
            <Item>
                <Item.Content>
                    ...
                    <ChannelSelector channelType='youtube'
                                     selectedChannel={this.state.channel}
                                     allowCustomChannel={this.props.campaign != null}
